...
authors:
  - name: Eric Araújo
    ...
    url: https://www.calvin.edu/academics/computer-science/faculty/eric-araujo
license: CC-BY-4.0
---
...
9. Commit and push: `git add .`, `git commit -m "Complete hw4"`, `git push`.
...
Before writing a query, it helps to look at the raw data. Add a temporary function or open a `psql` / SQLTools session and run:

```sql
SELECT * FROM players LIMIT 10;
SELECT * FROM clubs;
SELECT * FROM matches ORDER BY match_date LIMIT 5;
```

Understanding what the data actually looks like will save you a lot of time.
