...
Log in to [supabase.com](https://supabase.com), open the class project, and use the **SQL Editor** tab. You can run any `SELECT` query there without installing anything.
