...
In this assignment you will complete a Flask web application by writing SQL queries against a **European Football League** database hosted on Supabase. Every question requires at least one `JOIN` — that is the whole point of this assignment.
